...
// Based on: https://github.com/aws/amazon-chime-sdk-js/blob/master/demos/browser/server.js
...
http.createServer({}, async (request, response) => {
  ...
  try {
    ...
    } else if (request.method === 'GET' && requestUrl.pathname.includes('.js')) {
      // Return the contents of the index page
      respond(response, 200, 'text/javascript', fs.readFileSync(`.${requestUrl.pathname}`));
